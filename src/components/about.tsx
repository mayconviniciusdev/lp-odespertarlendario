    ...
    <>
      ...
      <section className="py-14 text-center max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 text-white text-lg">
          <div className="flex flex-col items-center justify-center bg-wellows/80 p-6 rounded-2xl">
            <FaFeather className="mb-2 text-2xl"/>
            <p>Design intuitivo e amigável</p>
          </div>

          <div className="flex flex-col items-center justify-center col-span-2 bg-wellows/95 p-6 rounded-2xl">
          ...
          <div className="flex flex-col items-center justify-center bg-wellows/95 p-6 rounded-2xl">
