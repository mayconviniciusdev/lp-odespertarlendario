  ...
  return (
    <header className="bg-dark px-5">
      <div className="py-12 mx-auto container text-center text-white">
        <h2 className="max-w-2xl mx-auto font-bold text-3xl">Seja o <strong className="text-golden-wellow underline">protagonista</strong> da sua própria vida e crie um estilo de vida <strong className="text-golden-wellow underline">ultra lendário</strong>.</h2>
